...
$sql = "INSERT INTO `eviid2`.`dataeviid2` (`EvidenceId`, `EvidenceTitle`, `EvidenceDesciption`, `Date`, `Status`, `Collectedby`) VALUES ('$number', '$casetitle', '$des', '$date', '$status', '$assign')";
if($con->query($sql))
{
...
<body>
    <div class="form-container">
        <form action="Evidence.php" method="post">
            <h2 style="color: white;" >Evidence entry Form</h2>
            <label for="caseNumber" style="color:white">Evidence Number</label>
            <input type="text" id="caseNumber" name="caseNumber" required>

            <label for="caseTitle"  style="color:white">Evidence Title</label>
            <input type="text" id="caseTitle" name="caseTitle" required>

            <label for="caseDescription"  style="color:white">Evidence Desciption</label>
            ...
            <label for="assignedTo"  style="color:white">Collected By</label>
